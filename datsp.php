...
<html lang="en">
    <head>
        ...
        <link href="css/datsp.css" rel="stylesheet">
  ...
  <script type="text/javascript" src="http://webquangnam.com/jsShare/hoa-dao-roi.js"></script>
    ...
    <div class="container">
        <div class="san_pham">
            ...
            <div class="img-sp">
                <div class="img-con">
                <img src="img/img-sp/img-41.jpg" id="img-one">
                <img src="img/img-sp/img-4.jpg" id="img-two">
                </div>
                <div class="img-change">
                    <img src="img/img-sp/img-4.jpg" alt=""id="change" class="btn">
                </div>
                <script>
                    $(document).ready(function(){
                        $('#img-one').click(function(){
                            $('#change').attr("src","img/img-sp/img-41.jpg");
                        });
                        $('#img-two').click(function(){
                            $('#change').attr("src","img/img-sp/img-4.jpg");
                        });
                        
                    });
                </script>
            </div>
            <div class="thong_tin"> <?php include("chuc_nang/datsp/sp1.php")?>
                <script>
        ...
        <?php include("chuc_nang/datsp/test.php")?>
            </div>
    </div>
