    ...
    <div class="container">
        ...
        <div class="khuyen_mai">
            ...
            <div class="row" style="float:left">
               <div class="col-6" >
               <?php include("chuc_nang/khuyen_mai/khuyen_mai.php")?>
               </div>
               <div class="col-6">
               <?php include("chuc_nang/khuyen_mai/khuyen_mai2.php")?>
               </div>
               <div class="col-6">
               <?php include("chuc_nang/khuyen_mai/khuyen_mai3.php")?>
               </div>
               <div class="col-6">
               <?php include("chuc_nang/khuyen_mai/khuyen_mai4.php")?>
               </div>
            </div>
        </div>
